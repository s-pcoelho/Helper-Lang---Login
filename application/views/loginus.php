			...
			<div class="offset-4 col-4">
				<div class="jumbotron form-login">
					...
					<hr class="my-4">
						...
						<div class="form-group">
							<div class="row">
								<button class="btn btn-success btn-block" type="submit"><?=$data['btnLogin']=$this->lang->line('btnLogin')?></button>
							</div>
						</div>
						</form>
						<hr class="my-4">
						<div class="form-group">
							<div class="row">
								<a href="<?=base_url()?>cadastro" class="btn btn-primary btn-block"><?=$data['btnRegis']=$this->lang->line('btnRegis')?></a>
							</div>
						</div>
					</div>
				</div>
